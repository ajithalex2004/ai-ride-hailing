        ...
        <div className="min-h-screen bg-[var(--t-bg)] text-[var(--t-text)] p-6 font-sans selection:bg-neon-blue/30">
            ...
            <div className="flex justify-between items-end mb-12">
                <div>
                    ...
                    <h1 className="text-4xl font-black tracking-tighter italic uppercase" style={{fontFamily:"var(--font-heading)",letterSpacing:"-0.02em"}}>PASSENGER_RELIABILITY_OS</h1>
                </div>
                ...
                <div className="flex gap-4">
                    <div className="bg-[var(--t-card)] border border-white/5 px-6 py-4 rounded-2xl flex items-center gap-3">
                        <div className="text-right">
                            ...
                            <div className="text-xl font-mono font-black text-neon-blue" style={{fontFamily:"var(--font-mono)"}}>842</div>
                        </div>
            ...
            <div className="grid grid-cols-12 gap-8">
                ...
                <div className="col-span-8 space-y-6">
                    <div className="bg-[var(--t-card)] border border-white/5 rounded-2xl p-6 h-[450px] flex flex-col relative overflow-hidden group">
                        <div className="absolute top-0 right-0 w-64 h-64 bg-neon-blue/5 blur-[100px] rounded-full" />

                        <div className="flex justify-between items-center mb-10 relative z-10">
                            <div>
                                <h3 className="text-[10px] font-black uppercase text-muted-grey tracking-[0.3em] mb-1" style={{fontFamily:"var(--font-heading)"}}>Loyalty_Tier_Distribution</h3>
                    ...
                    <div className="bg-[var(--t-card)] border border-white/5 rounded-2xl overflow-hidden">
                        <div className="p-8 border-b border-white/5 flex justify-between items-center bg-[var(--t-card)]">
                            <h2 className="text-xl font-black italic tracking-tight uppercase" style={{fontFamily:"var(--font-heading)"}}>Predictive_Route_Personalization</h2>
                        ...
                        <div className="p-8 grid grid-cols-2 gap-8">
                            ...
                            <div className="bg-black/40 border border-white/5 rounded-2xl p-6 flex flex-col justify-center text-center">
                                ...
                                <div className="text-lg font-black font-mono leading-none mb-2 italic" style={{fontFamily:"var(--font-mono)"}}>84.2%</div>
                ...
                <div className="col-span-4 space-y-6">
                    <div className="bg-[var(--t-card)] border border-white/5 rounded-2xl p-6">
                        <h3 className="text-[10px] font-black uppercase text-muted-grey mb-8 tracking-[0.3em]" style={{fontFamily:"var(--font-heading)"}}>Subscription_Profiles</h3>
                        <div className="space-y-4">
                    ...
                    <div className="bg-red-500/5 border border-red-500/20 p-6 rounded-2xl">
                        ...
                        <p className="text-[10px] text-muted-grey leading-relaxed mb-6 italic"> AI predicts <span className="text-[var(--t-text)] font-bold">142 "Gold" members</span> are at risk of churning due to service delays in Zone_4. </p>
                    ...
                    <div className="bg-[var(--t-card)] border border-white/10 p-6 rounded-2xl group cursor-pointer hover:bg-white/5 transition-all">
                        <div className="flex items-center justify-between mb-4">
                            <div className="p-3 bg-[var(--t-card)] rounded-xl text-yellow-400">
                                <Crown size={20} />
                            </div>
                            <div className="text-[10px] font-black text-[var(--t-text)] italic tracking-tighter uppercase px-3 py-1 bg-yellow-400/10 rounded-full">VIP_ECHO_ENABLED</div>
                        </div>
                        <div className="text-[10px] font-black uppercase tracking-widest mb-2">Priority_Dispatch_Monitor</div>
                        <div className="text-[8px] text-muted-grey uppercase leading-relaxed">VIP members receiving <span className="text-[var(--t-text)] font-bold">-2.4m ETA priority</span> on average across the platform.</div>
                    </div>
                </div>
...
function InsightStat({ label, value, sub, icon: Icon, color = "text-[var(--t-text)]" }: any) {
    return (
...
function TierBar({ label, value, color, height }: any) {
    return (
        <div className="flex flex-col items-center gap-4 group">
            <div className="text-[10px] font-black font-mono mb-2 opacity-0 group-hover:opacity-100 transition-opacity uppercase" style={{fontFamily:"var(--font-mono)"}}>{value}</div>
...
function SubProfile({ label, price, count }: any) {
    return (
        <div className="flex justify-between items-center p-4 bg-black/40 rounded-xl border border-white/5 group hover:border-neon-blue/40 transition-all cursor-pointer">
            <div>
                <div className="text-[10px] font-black text-[var(--t-text)] italic uppercase">{label}</div>
                <div className="text-[8px] font-bold text-muted-grey uppercase">{count} Profiles Active</div>
            </div>
            <div className="text-xs font-black font-mono text-neon-blue" style={{fontFamily:"var(--font-mono)"}}>{price}</div>
        </div>
    );
}
