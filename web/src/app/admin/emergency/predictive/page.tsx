                ...
                <div className="col-span-4 space-y-6">
                    <div className="bg-[var(--t-card)] border border-[var(--t-border)] rounded-[40px] p-8">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="pt-8 border-t border-[var(--t-border)]">
                                <div className="text-[10px] font-black uppercase italic text-[var(--t-text-muted)] mb-4 tracking-widest">Recommended_Action</div>
    ...
    return (
        <div className="space-y-3">
            ...
            <div className="relative w-full bg-white/5 h-1.5 rounded-full overflow-hidden">
                ...
                <div className={`h-full ${warn ? 'bg-red-500' : 'bg-[var(--t-accent)]'} opacity-40`} style={{ width: `${(predicted / 10) * 100}%` }} />
            </div>
        </div>
    );
}
...
function MoveUpItem({ unit, current, target, eta }: any) {
    return (
        <div className="flex items-center gap-4 bg-white/5 p-4 rounded-2xl hover:bg-white/[0.08] transition-all cursor-pointer border border-transparent hover:border-[var(--t-border)]">
            <div className="p-2 bg-[var(--t-accent)]/10 rounded-xl text-[var(--t-cyan)]">
                <MoveUp size={16} />
            </div>
