        ...
        <div className="min-h-screen bg-[var(--t-bg)] text-white p-8 selection:bg-[var(--t-accent)]/30" style={{fontFamily:"var(--font-sans)"}}>
            ...
            <div className="flex justify-between items-end mb-12">
                ...
                <div className="flex gap-4">
                    ...
                    <button className="bg-white text-black px-8 py-4 rounded-2xl font-black text-sm uppercase tracking-tighter flex items-center gap-2 hover:bg-[var(--t-accent)] transition-all">
            ...
            <div className="grid grid-cols-12 gap-8">
                ...
                <div className="col-span-8 flex flex-col space-y-6">
                    <div className="bg-[var(--t-card)] border border-[var(--t-border)] rounded-3xl p-8 flex-1 relative overflow-hidden group">
                        ...
                        <div className="relative z-10 flex-1 h-[400px] border border-[var(--t-border)] rounded-2xl bg-[var(--t-surface)] flex items-center justify-center">
                            <div className="text-center group-hover:scale-105 transition-transform duration-700">
                                ...
                                <span className="text-[10px] font-black uppercase text-white/20 tracking-[0.4em] italic leading-loose">
                                    ...
                                    <span className="text-[var(--t-cyan)] font-mono font-bold tracking-normal opacity-40">DXB_CORE_GRID_V2.0</span>
                                </span>
                            </div>
                            ...
                            <div className="absolute bottom-8 right-8 flex items-center gap-4 bg-black/60 border border-[var(--t-border)] p-4 rounded-xl">
                                <div className="text-right">
                                    ...
                                    <div className="text-lg font-mono font-black text-[var(--t-cyan)]">0.92</div>
                                </div>
                ...
                <div className="col-span-4 space-y-6">
                    <div className="bg-[var(--t-card)] border border-[var(--t-border)] rounded-3xl p-8">
                        <h3 className="text-[10px] font-black uppercase text-[var(--t-text-muted)] mb-8 tracking-[0.3em]">AI_Earnings_Forecast</h3>
                        <div className="space-y-6">
                            <div className="p-6 bg-[var(--t-surface)] border border-[var(--t-border)] rounded-2xl">
                                ...
                                <div className="text-2xl font-black font-mono leading-none mb-1 text-[var(--t-cyan)]">$182.40</div>
                    ...
                    <div className="bg-[var(--t-card)] border border-[var(--t-border)] rounded-3xl p-8">
                        <h3 className="text-[10px] font-black uppercase text-[var(--t-text-muted)] mb-8 tracking-[0.3em]">Utilization_Optimizer</h3>
                    ...
                    <div className="bg-[var(--t-card)] border border-[var(--t-border)] rounded-3xl p-6 flex items-center justify-between group cursor-pointer hover:bg-white/5 transition-colors">
...
function MetricCard({ label, value, sub, icon: Icon, color = "text-white" }: any) {
    return (
        <div className="bg-[var(--t-card)] border border-[var(--t-border)] rounded-3xl p-8 flex items-center gap-6">
...
function LayerButton({ active, onClick, label }: any) {
    return (
        <button onClick={onClick} className={`px-4 py-2 rounded-xl text-[9px] font-black uppercase transition-all flex items-center gap-2 ${active ? 'bg-white/10 text-white' : 'text-[var(--t-text-muted)] hover:bg-white/5'
            }`}>
